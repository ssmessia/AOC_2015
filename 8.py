raw=r'''"sjdivfriyaaqa\xd2v\"k\"mpcu\"yyu\"en"
"vcqc"
...
code_length, string_length, new_length = 0,0,0
for r in raw:
    print(r, len(r), findSpecial(r), findAdditional)
    code_length+=len(r)
    string_length+=(len(r)-findSpecial(r)-2)
    new_length+=(len(r)+findAdditional(r)+4)
print(code_length-string_length)
print(new_length-code_length)
